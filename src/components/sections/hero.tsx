...
export function Hero() {
  ...
  return (
    ...
    >
      <div className="wrap">
        <div className="grid w-full grid-cols-1 items-center gap-[clamp(1.5rem,4vw,3.5rem)] lg:grid-cols-[minmax(0,1.05fr)_minmax(18rem,1fr)]">
          <div className="min-w-0">
            ...
            <Reveal delay={0.24} className="mt-12 flex flex-wrap gap-3 max-md:flex-col">
              ...
              <a href="#businesses" className="btn max-md:w-full">
                {t("cta2")}
              </a>
            </Reveal>
            <Reveal delay={0.32} className="mt-[clamp(2rem,5vh,3.25rem)] border-t border-border pt-6 text-[12px] tracking-[0.04em] text-faint">
              {t("trust1")}
            </Reveal>
          </div>
          <HeroStage />
